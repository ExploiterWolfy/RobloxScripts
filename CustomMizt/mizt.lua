...
if Bypass == "limbs" then --------------------------------------------------------------------------------------------------------------------
	...
	workspace["miztCloneChar"].Humanoid.WalkToPoint = LVecPart.Position
	end
	...
	if WDown ~= true and ADown ~= true and SDown ~= true and DDown ~= true then
     workspace["miztCloneChar"].Humanoid.WalkToPoint = workspace["miztCloneChar"].HumanoidRootPart.Position end
	end 
	end)()
